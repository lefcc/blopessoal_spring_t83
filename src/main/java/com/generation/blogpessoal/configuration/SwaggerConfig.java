    ...
    OpenAPI springBlogPessoalOpenAPI() {
        return new OpenAPI()
            .info(new Info()
                ...
                .license(new License()
                    .name("Letícia Campos")
                    .url("https://github.com/lefcc"))
                .contact(new Contact()
                    .name("Letícia Campos")
                    .url("https://github.com/lefcc")
                    .email("leticiafccampos@gmail.com")))
            .externalDocs(new ExternalDocumentation()
                .description("Repositório do Projeto Blog Pessoal - Github")
                .url("https://github.com/lefcc/blogpessoal_spring_t83"))
